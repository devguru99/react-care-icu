...
export default function Service() {
  return (
    ...
    >
      ...
      >
        {tiers.map((tier) => (
          <Grid size={{ xs: 12, sm: 12, md: 6 }} key={tier.title}>
            <Card
              sx={[
                {
                  p: 4,
