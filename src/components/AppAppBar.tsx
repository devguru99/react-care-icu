        ...
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              ...
              <NavButton to="/contact" sx={{ minWidth: 0 }}>
                Contact
              </NavButton>
            </Box>
          </Box>
          ...
          >
            <Button
              ...
              variant="contained"
              size="small"
              title="New patient click here, please!"
            >
              Book Appointment
            </Button>
            <Button
              component={NavLink}
              to="https://phr.charmtracker.com/login.sas?FACILITY_ID=3a3047be28b32bf90ac91ebef680b83b04bc39bf0678b4a598ee2e5ce9d5cc8ac81b440bc8a53a00"
              target="_blank"
          ...
          <Box sx={{ display: { xs: "flex", md: "none" }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: "background.default" }}>
                ...
                <MenuItem component={NavLink} to="/services">
                  Services
                </MenuItem>
                <MenuItem component={NavLink} to="/about">
                  About
                </MenuItem>
                <MenuItem component={NavLink} to="/blogs">
                  Blog
                </MenuItem>
                <MenuItem component={NavLink} to="/resource">
                  Resources
                </MenuItem>
                <MenuItem component={NavLink} to="/story">
