import{c as C,j as c}from"./index-C-omLiZr.js";import{g as b,d as k,k as u,e as m,s as w,f as x,h as R,u as S,i as $,j as M,c as U}from"./App-QBIGy6XI.js";function j(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return k("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const B=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return M({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},X,e)},r=u`
  0% {
    opacity: 1;
  }
